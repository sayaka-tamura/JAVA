 ...
 * The BankAccount class simulates a bank account.
   make constructors for balance field of BankAccount(3 types)
   make methods deposit and withdraw
...
class BankAccount 
{
	...
	public BankAccount(String str)
   {
	...
	/**
	 * The deposit method make a deposit into the account.
	 *
	...
	public void withdraw(double amount)
   {
	...
	/**
	 * The withdraw method withdraw s an amount from the account.
	 *
	...
	public void setBalance(double b)
   {
	...
	/**
	 * The setBalance method sets a the account balance,
	 *
