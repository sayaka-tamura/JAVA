/*
   ...
   File name: ChoHan.java
   Date: 9/18/2016
   Result ex:
 Enter the first plalyer's name: sayaka
 Enter the second player's name: kaz
 -----------------------
 Now playing round 1.
 The dealer rolled 3 and 6.
 Result: Han (odd)
 The player sayaka guessed Han (odd).
 Awarding 1 point(s) to sayaka.
 The player kaz guessed Han (odd).
 Awarding 1 point(s) to kaz.
 -----------------------
 Now playing round 2.
 ...
 -----------------------
 Now playing round 3.
 The dealer rolled 6 and 4.
 Result: Cho (even)
 The player sayaka guessed Han (odd).
 The player kaz guessed Cho (even).
 Awarding 1 point(s) to kaz.
 -----------------------
 Now playing round 4.
 The dealer rolled 3 and 1.
 Result: Cho (even)
 The player sayaka guessed Cho (even).
 Awarding 1 point(s) to sayaka.
 The player kaz guessed Han (odd).
 -----------------------
 Now playing round 5.
...
public class ChoHan {
	public static void main(String[] args) {
		final int MAX_R0UNDS = 5; // Number of rounds
		...
		System.out.print("Enter the first plalyer's name: ");
		...
		// Play the rounds.
		for (int round = 0; round < MAX_R0UNDS; round++) {
			System.out.println("-----------------------");
